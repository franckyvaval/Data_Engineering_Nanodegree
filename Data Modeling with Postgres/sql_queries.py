...
(songplay_id SERIAL PRIMARY KEY, start_time BIGINT NOT NULL,\
 user_id int NOT NULL, level text, song_id varchar,\
...
(song_id varchar PRIMARY KEY, title text NOT NULL,\
artist_id varchar, year int, duration float NOT NULL)
""")

artist_table_create = ("""CREATE table IF NOT EXISTS artists\
(artist_id varchar PRIMARY KEY, name text NOT NULL,\
...
name, location, latitude, longitude) VALUES \
...
song_select = (""" SELECT s.song_id AS song_id, a.artist_id \
AS artist_id FROM ( songs s INNER JOIN artists a\
